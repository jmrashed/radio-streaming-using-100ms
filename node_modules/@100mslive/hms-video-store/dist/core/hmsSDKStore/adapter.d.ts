...
export declare class SDKToHMS {
    ...
    static enrichLocalTrack(track: HMSTrack, sdkTrack: SDKHMSTrack): void;
    ...
    static convertRecordingStreamingState(recording?: sdkTypes.HMSRecording, rtmp?: sdkTypes.HMSRTMP, hls?: sdkTypes.HMSHLS): {
