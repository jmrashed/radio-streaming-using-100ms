...
export interface HMSPeerNotification extends BaseNotification {
    type: HMSNotificationTypes.PEER_JOINED | HMSNotificationTypes.PEER_LEFT | HMSNotificationTypes.NAME_UPDATED | HMSNotificationTypes.METADATA_UPDATED | HMSNotificationTypes.ROLE_UPDATED;
    data: HMSPeer;
}
...
export interface HMSTrackNotification extends BaseNotification {
    type: HMSNotificationTypes.TRACK_ADDED | HMSNotificationTypes.TRACK_DEGRADED | HMSNotificationTypes.TRACK_UNMUTED | HMSNotificationTypes.TRACK_DESCRIPTION_CHANGED | HMSNotificationTypes.TRACK_MUTED | HMSNotificationTypes.TRACK_REMOVED | HMSNotificationTypes.TRACK_RESTORED;
    data: HMSTrack;
}
...
declare type MappedNotifications<Type extends HMSNotificationTypes[]> = {
    [index in keyof Type]: HMSNotificationMapping<Type[index]>;
};
export declare type HMSNotificationTypeParam = HMSNotificationTypes | HMSNotificationTypes[] | undefined;
export declare type HMSNotificationInCallback<T extends HMSNotificationTypeParam> = T extends HMSNotificationTypes[] ? MappedNotifications<T>[number] : T extends HMSNotificationTypes ? HMSNotificationMapping<T> : HMSNotification;
export declare type HMSNotificationCallback<T extends HMSNotificationTypeParam> = (notification: HMSNotificationInCallback<T>) => void;
/**
 * @category Core
 */
