...
import { AcceptRoleChangeParams, BroadcastResponse, GetSessionMetadataResponse, HLSRequestParams, HLSTimedMetadataParams, MultiTrackUpdateRequestParams, RemovePeerRequest, RequestForBulkRoleChangeParams, RequestForRoleChangeParams, SetSessionMetadataParams, SetSessionMetadataResponse, StartRTMPOrRecordingRequestParams, Track, TrackUpdateRequestParams, UpdatePeerRequestParams } from '../interfaces';
...
export default class JsonRpcSignal implements ISignal {
    ...
    close(): Promise<void>;
    join(name: string, data: string, disableVidAutoSub: boolean, serverSubDegrade: boolean, simulcast: boolean, offer?: RTCSessionDescriptionInit): Promise<RTCSessionDescriptionInit>;
